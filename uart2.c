...
/* putcU2 FUNCTION DESCRIPTION ********************************************
 @SYNTAX:           BOOL putU2( int c);
  
 @KEYWORDS:         UART, character
  
 @DESCRIPTION:      Send single character to UART2. Waits while UART2 is busy 
                    (buffer full) and then sends a single byte to UART2
