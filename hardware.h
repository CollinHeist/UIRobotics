...
#ifndef _BASYS_MX3A_
    #define _BASYS_MX3A_
    #define USE_TEMPERATUER_TMP03
//    #include <plib.h>

/* The following definitions are for IO assigned on the Digilent Trainer board
 * processor board */

/* Macros to configure PIC pins as inputs for push button sensors */
    #define BTNL_bit    BIT_0   // RB0  - only functional in stand alone mode
    #define BTNR_bit    BIT_8   // RB8
    #define BTNU_bit    BIT_1   // RB1  - only functional in stand alone mode
    #define BTND_bit    BIT_15  // RA15
    #define BTNC_bit    BIT_0   // RF0

    #define BNTL()      PORTBbits.RB0  // PORTReadBits(IOPORT_B, BTNL_bit)
    #define BNTR()      PORTBbits.RB8  // PORTReadBits(IOPORT_B, BTNR_bit)
    #define BNTU()      PORTBbits.RB1  // PORTReadBits(IOPORT_B, BTNU_bit)
    #define BNTD()      PORTAbits.RA15 // PORTReadBits(IOPORT_A, BTND_bit)
    #define BNTC()      PORTFbits.RF0  // PORTReadBits(IOPORT_F, BTNC_bit)

/* http://umassamherstm5.org/tech-tutorials/pic32-tutorials/pic32mx220-tutorials/internal-pull-updown-resistors */

    #define BTNLcfgIn()  (PORTSetPinsDigitalIn(IOPORT_B, BTNL_bit), CNPDBbits.CNPDB0 = 1) // RB1 With pulldown//  - Analog Input pin
//  #define BTNLcfgIn()  (PORTSetPinsDigitalIn(IOPORT_B, BTNL_bit)) // RB1 With pull down//  - Analog Input pin
...
//  #define BTNUcfgIn()  (PORTSetPinsDigitalIn(IOPORT_B, BTNU_bit)) // RB0 With pull down//  - Analog Input pin
